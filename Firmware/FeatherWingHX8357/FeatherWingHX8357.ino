...
void setup(void) {
  ...
  // Serial.print(F("Loading ritlogo.bmp to canvas..."));
  // stat = reader.loadBMP("/ritlogo.bmp", img);
  // reader.printStatus(stat); // How'd we do?
...
void loop() {
  ...
  reader.drawBMP("/ritlogo.bmp", tft, 0, 0);

  delay(5000);

  reader.drawBMP("/revbiologo.bmp", tft, 0, 0);
